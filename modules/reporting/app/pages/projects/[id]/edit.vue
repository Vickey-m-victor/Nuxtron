...
import type { Projects, ProjectsUpdatePayload } from '../../types/projects-dto.js'
...
const formData = ref<ProjectsUpdatePayload>({
  id: Number(id),
...
<template>
  <div class="content">
    <BasePageHeading :title="'Edit Projects'">
      <template #extra>
        <button 
          type="button" 
    ...
    <BaseBlock title="Update Projects" subtitle="Modify the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Update the form fields to modify this projects.
            </p>
          </div>

...
import type { PaymentMethods, PaymentMethodsUpdatePayload } from '../../types/payment-methods-dto.js'
...
const formData = ref<PaymentMethodsUpdatePayload>({
  id: Number(id),
...
const handleSubmit = async () => {
  ...
  try {
    ...
    router.push(`/reporting/payment-methods`)
  } catch (err: any) {
...
<template>
  <div class="content">
    <BasePageHeading :title="'Edit PaymentMethods'">
      <template #extra>
        <button 
          type="button" 
          class="btn btn-alt-secondary"
          @click="() => router.push(`/reporting/payment-methods`)"
        >
    ...
    <BaseBlock title="Update PaymentMethods" subtitle="Modify the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Update the form fields to modify this paymentmethods.
            </p>
          </div>
          <div class="col-lg-8 col-xl-7">
            ...
            <div class="mb-4 pt-3 border-top">
              <button type="submit" class="btn btn-primary" :disabled="loading">
                ...
                {{ loading ? 'Updating...' : 'Update PaymentMethods' }}
              </button>
              <button 
                type="button" 

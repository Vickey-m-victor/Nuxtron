...
const formData = ref<SuppliersCreatePayload>({
  name: '',
  is_deleted: 0,
  status: 0
})
...
<template>
  <div class="content">
    <BasePageHeading :title="'Create Suppliers'">
      <template #extra>
        <button 
          type="button" 
    ...
    <BaseBlock title="New Suppliers" subtitle="Fill in the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Provide the required information to create a new suppliers.
            </p>
          </div>
          <div class="col-lg-8 col-xl-7">
            ...
            <div class="mb-4 pt-3 border-top">
              <button type="submit" class="btn btn-primary" :disabled="loading">
                ...
                {{ loading ? 'Creating...' : 'Create Suppliers' }}
              </button>
              <button 
                type="button" 

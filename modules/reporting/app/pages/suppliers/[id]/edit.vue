...
import type { Suppliers, SuppliersUpdatePayload } from '../../types/suppliers-dto.js'
...
const formData = ref<SuppliersUpdatePayload>({
  id: Number(id),
...
<template>
  <div class="content">
    <BasePageHeading :title="'Edit Suppliers'">
      <template #extra>
        <button 
          type="button" 
          class="btn btn-alt-secondary"
          @click="() => router.push(`/reporting/suppliers`)"
        >
    ...
    <BaseBlock title="Update Suppliers" subtitle="Modify the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Update the form fields to modify this suppliers.
            </p>
          </div>
          <div class="col-lg-8 col-xl-7">
            ...
            <div class="mb-4 pt-3 border-top">
              <button type="submit" class="btn btn-primary" :disabled="loading">
                ...
                {{ loading ? 'Updating...' : 'Update Suppliers' }}
              </button>
              <button 
                type="button" 

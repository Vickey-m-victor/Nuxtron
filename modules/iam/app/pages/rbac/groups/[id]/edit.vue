...
import type { Groups, GroupsUpdatePayload } from '../../../types/groups-dto.js'
...
const formData = ref<GroupsUpdatePayload>({
  id: Number(id),
...
<template>
  <div class="content">
    <BasePageHeading :title="'Edit Groups'">
      <template #extra>
        <button 
          type="button" 
    ...
    <BaseBlock title="Update Groups" subtitle="Modify the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Update the form fields to modify this groups.
            </p>
          </div>

...
const formData = ref<ResetPasswordCreatePayload>({
  password: '',
  confirmPassword: ''
})
...
<template>
  <div class="content">
    <BasePageHeading :title="'Create ResetPassword'">
      <template #extra>
        <button 
          type="button" 
    ...
    <BaseBlock title="New ResetPassword" subtitle="Fill in the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Provide the required information to create a new resetpassword.
            </p>
          </div>
          <div class="col-lg-8 col-xl-7">
            ...
            <div class="mb-4 pt-3 border-top">
              <button type="submit" class="btn btn-primary" :disabled="loading">
                ...
                {{ loading ? 'Creating...' : 'Create ResetPassword' }}
              </button>
              <button 
                type="button" 

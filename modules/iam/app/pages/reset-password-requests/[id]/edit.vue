...
import type { ResetPasswordRequest, ResetPasswordRequestUpdatePayload } from '../../types/reset-password-request-dto.js'
...
const formData = ref<ResetPasswordRequestUpdatePayload>({
  id: Number(id),
...
<template>
  <div class="content">
    <BasePageHeading :title="'Edit ResetPasswordRequest'">
      <template #extra>
        <button 
          type="button" 
    ...
    <BaseBlock title="Update ResetPasswordRequest" subtitle="Modify the details below" content-full>
      <!-- Error Alert -->
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Update the form fields to modify this resetpasswordrequest.
            </p>
          </div>
          <div class="col-lg-8 col-xl-7">
            ...
            <div class="mb-4 pt-3 border-top">
              <button type="submit" class="btn btn-primary" :disabled="loading">
                ...
                {{ loading ? 'Updating...' : 'Update ResetPasswordRequest' }}
              </button>
              <button 
                type="button" 
